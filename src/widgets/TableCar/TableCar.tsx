        ...
        >
                <Table>
                    ...
                    <tr>
                        ...
                        <InputSelect valueDispatch={"machine_model"} keyInput={"machine_model__name"} role={role} listMachine={listMachine.filter_data.machine_models} valueInput={car.machine_model} header={"Модель машины"}/>
                        <InputSelect valueDispatch={"engine_model"} keyInput={"engine_model__name"} role={role} listMachine={listMachine.filter_data.engine_models} valueInput={car.engine_model} header={"Модель двигателя"}/>
                        <InputArea role={role} valueInput={car.engine_number} valueDispatch={"engine_number"} header={"Зав. № двигателя"}/>
                        <InputSelect valueDispatch={"transmission_model"} keyInput={"transmission_model__name"} role={role} listMachine={listMachine.filter_data.transmission_models} valueInput={car.transmission_model} header={"Модель трансмиссии"}/>
                        <InputArea header={"Зав. № трансмиссии"} valueDispatch={"transmission_number"} role={role} valueInput={car.transmission_number}/>
                        <InputSelect valueDispatch={"driving_bridge_model"} keyInput={"driving_bridge_model__name"} role={role} listMachine={listMachine.filter_data.driving_bridge_models} valueInput={car.driving_bridge_model} header={"Модель ведущего моста"}/>
                        <InputArea role={role} valueInput={car.driving_bridge_number} valueDispatch={"driving_bridge_number"} header={"Зав. № ведущего моста"}/>
                        <InputSelect valueDispatch={"controlled_bridge_model"} keyInput={"controlled_bridge_model__name"} role={role} listMachine={listMachine.filter_data.controlled_bridge_models} valueInput={car.controlled_bridge_model} header={"Модель управляемого моста"}/>
